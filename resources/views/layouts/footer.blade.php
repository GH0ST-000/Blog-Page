<footer class="bg-gray-800 py-20 mt-20 ">
    <div class="sm:grid grid-cols-3 w-4/5 pb-10  m-auto border-b-2 border-gray-700" >
        <div>
            ...
            <ul class="py-4 sm:tex-s pt-4 text-gray-400">
        ...
        <div>
            ...
            <ul class="py-4 sm:tex-s pt-4 text-gray-400">
                ...
                <li class="pb-1"><a href="/">Why We Love Desing</a></li>
                <li class="pb-1"><a href="/">Why To Use Laravel</a></li>
                <li class="pb-1"><a href="/">Why Php Is Best</a></li>
            </ul>

        </div>
    </div>
    <p class="w-25 w-4/5 pb-3 m-auto text-xs text-gray-100 pt-6">
Copyright 2021-08-13 By HADES11.All Rights Reserved
    </p>
</footer>
